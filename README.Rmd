...
```{r}
to_exclude <- c("lib", "chart-menu", "ONS charts cheat sheet.svg", "Modularisation_notes.md", "README.md", "README.rmarkdown", "refresh.bat", "schema.JSON", "ONSCharts.Rproj", "README.Rmd")
folders <- dir()
