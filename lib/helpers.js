...
export function addAnnotationArrow(
  svgName,
  xValue,
  yValue,
  arrowOffsetX,
...
export function addDirectionArrow(
  svgName,
  direction,
  arrowAnchor,
  xValue,
  ...
  // text x anchor
  if (
    (direction == "left" && arrowAnchor == "end") ||
    (direction == "right" && arrowAnchor == "start")
  ) {
    TextOffsetX = 12.5 + textPadding;
  }
  if (
    (direction == "right" && arrowAnchor == "end") ||
    (direction == "left" && arrowAnchor == "start")
  ) {
    TextOffsetX = 0 - textPadding;
  }
  ...
  if (
    ...
    xValue = xValue + arrowPadding;
  }
  if (
    (direction == "right" && arrowAnchor == "end") ||
    (direction == "left" && arrowAnchor == "start")
  ) {
    xValue = xValue - arrowPadding - 12.5;
  }

  //alginment
  if (
    (direction == "right" && alignment == "above") ||
    (direction == "left" && alignment == "above")
  ) {
    yValue = yValue + arrowPadding;
  }
  if (
    (direction == "right" && alignment == "below") ||
    (direction == "left" && alignment == "below")
  ) {
    yValue = yValue - arrowPadding;
  }
  ...
  // arrow anchor
  if (
    (direction == "down" && arrowAnchor == "start") ||
    (direction == "up" && arrowAnchor == "end")
  ) {
    yValue = yValue + arrowPadding;
  }
  if (
    (direction == "down" && arrowAnchor == "end") ||
    (direction == "up" && arrowAnchor == "start")
  ) {
    yValue = yValue - arrowPadding - 14;
  }

  //x position for arrow
  if (
    (direction == "down" && alignment == "right") ||
    (direction == "up" && alignment == "right")
  ) {
    xValue = xValue - arrowPadding - 12.5;
  }
  if (
    (direction == "down" && alignment == "left") ||
    (direction == "up" && alignment == "left")
  ) {
    xValue = xValue + arrowPadding;
  }
...
export function addElbowArrow(
  ...
  // 'start', 'center', 'end' - where text appears on the line
  ...
  if (textAlignment === "start") {
    ...
    // center - position at the bend point
    textX = bendX;
    textY = bendY;
  }
 ...
 */
export function addAnnotationLineVertical(
  svgName,
  height,
  xValue,
  thisText,
 ...
 * @param {string} size - Chart size ('sm', 'md', 'lg').
 */
export function addAnnotationLineHorizontal(
  svgName,
  width,
  yValue,
  thisText,
 ...
 * @param {string} size - Chart size ('sm', 'md', 'lg').
 */
export function addAnnotationRangeVertical(
  svgName,
  height,
  xValue,
  xEndValue,
 ...
 * @param {string} size - Chart size ('sm', 'md', 'lg').
 */
export function addAnnotationRangeHorizontal(
  svgName,
  width,
  yValue,
  yEndValue,
...
export function customTimeAxis(scaleInput) {
  ...
  function resolvePrimaryLevel(domainSpanMonths) {
    if (primaryUnitOverride) {
      const level = TIME_LEVELS[primaryUnitOverride];
      if (!level) {
        throw new Error(
          `Invalid primaryUnit "${primaryUnitOverride}". ` +
          `Valid values: ${Object.keys(TIME_LEVELS).join(", ")}`
        );
      }
      return level;
    }
    ...
    selection.each(function () {
      ...
      const secondaryLevel =
        config?.labelSpans?.secondaryLabels && primaryLevel.parent
          ? TIME_LEVELS[primaryLevel.parent]
          : null;
