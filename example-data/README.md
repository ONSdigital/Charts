...
### [categorical-grouped-clustered.csv](categorical-grouped-clustered.csv)
...
### [categorical-grouped-long-ci.csv](categorical-grouped-long-ci.csv)

- [Range CI area grouped](https://onsdigital.github.io/Charts/range-ci-area-grouped/)

### [categorical-grouped-wide.csv](categorical-grouped-wide.csv)
...
### [categorical-grouped.csv](categorical-grouped.csv)
...
### [time-series-single.csv](time-series-single.csv)

- [Column chart](https://onsdigital.github.io/Charts/column-chart/)

### [time-series-wide.csv](time-series-wide.csv)
